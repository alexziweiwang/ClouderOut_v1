...
// TODO here, keeps all sub-component's "unsaved local" data structures
    ...
    const [pieceDataStructure, setPieceDatastructure] = useState([
            ...
            {"num": 3, "content": "c30003333333333333333333333333333333 ...", "displayTextFrame": true, "speaker_name": "", "bgp_source_varname": "",  "bgp_action": "maintainBgp", "bgp_pos_x": 0, "bgp_pos_y": 0, "bgp_width": 800, "bgp_height": 450, "chp_curr": ["", 0, 0, 60, 120, 1], "chp_arr": [], "chp_action": "maintainCharPicArr",  "clkb_previewing": [], "clkb_arr": [], "stnd_btn_arr": [], "bgm_source_varname": "", "bgm_action": "maintainBgm", "bgm_loop": true, "bgm_volume": 100, "vl_source_varname": "", "vl_volume": 100}, 
    ...
    const [logPageUISettings, setLogPageUISettings] = useState({
        ...
        "closeButtonShade": "",
        "closeButtonPicName": "",
        "closeButtonPositionX": 100, 
        "closeButtonPositionY": 100, 
        "closeButtonWidth": 300,
        "closeButtonHeight": 300, 
